...
class Ion_auth
{
	...
	public function __construct()
	{
		...
		$this->load->model('auth/Ion_auth_model', 'ion_auth_model'); // fix for HMVC
	...
	public function get_perusahaan_id()
	{
		$perusahaan_id = $this->session->userdata('company_id');
	...
	public function get_notifikasi_user()
	{
	...
	public function get_namkar_user()
	{
		$namkar = $this->session->userdata('namkar');
	...
	{
		$job = $this->session->userdata('id_job');

                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">                        
                            <i class="fa fa-fw ti-file"></i> List MRP                    
                        </h3>
                    ...
                    <!-- <a style="float:right" class="btn btn-success" href="<?= site_url('mrp/mrp_add/') ?>"><i class="fa fa-plus"></i> Upload Data</a> -->
                        ...
                        <div class="dataTable_wrapper">
                            <table class="table table-striped table-bordered table-hover" id="dt_employee" style="width:100%">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Date</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_employee').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('mrp/mrp_list')?>",
                "type": "POST"
            },

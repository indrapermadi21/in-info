		...
		<div class="col-xs-12">
			<div class="panel">
				...
				<div class="panel-body">
					<div class="col-xs-12">
						<?php echo form_open(current_url(),array('class'=>'form-horizontal', 'id'=>'authenticationGroups'));?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<p><?php echo form_input($group_description,$group_description,array('class'=>'form-control', 'id'=>'description', 'name'=>'description', 'type'=>'text'));?></p>
								</div>
							</div>
							<div class="row">
								<hr>
							...
							<div class="form-group">
								<div class="col-md-8 col-md-offset-3">
									<button class="btn btn-primary" type="submit" id="btn_submit" name="btn_submit" value="Save">Edit Group</button>
								</div>
							</div>
						<?php echo form_close();?>
					</div><!-- /.col -->

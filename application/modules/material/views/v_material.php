    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="float-right">
                <a href="<?= base_url('material/add_material') ?>" class="btn btn-sm btn-info">
            ...
            <table class="table table-striped table-bordered table-hover" id="dt_material">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kode Material</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_material').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('material/material_list') ?>",
                "type": "POST"
            },
    ...
    function delete_material(material_code) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url('material/delete_material/') ?>",
                    type: "POST",
                    data: {

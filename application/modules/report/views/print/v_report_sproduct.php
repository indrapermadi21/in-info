...
<body>
    <div style="text-align: center;">
        <strong><div class="style_head"><h3>Laporan Penjualan Produk</h3></strong>
    ...
    <table>
        <tr>
            ...
            <th style="text-align: center;" colspan="3"><strong>Customer</strong></th>
        </tr>
        <?php
        $total = 0;
        ...
        ?>
            <tr>
                ...
                <td coslpan="3"><?= $row['customer_name'] ?></td>
            </tr>
            <?php
            $sub_total = 0;

...
$pdf->SetTitle('Bukti Penerimaan Barang');
...
$pdf->Cell(0, 0, 'BUKTI PENERIMAAN BARANG', 0, 1, 'C');
...
<table border="0" cellspacing="0" cellpadding="2">
        <tr>
            ...
            <td width="10">:</td>
            <td width="150" >' . $result['gr_number'] . '</td>
            <td width="100" rowspan="3">Dari</td>
            <td width="10" rowspan="3">:</td>
            <td width="190" rowspan="3" >' . $result['supplier_name'] . '<br>' . $result['address'] . '</td>
        </tr>
        <tr>
            <td >Tanggal</td>
            <td>:</td>
...
ob_end_clean();
$pdf->Output('Bukti Penerimaan Barang.pdf', 'I');

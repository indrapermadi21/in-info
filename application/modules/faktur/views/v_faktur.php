    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="float-right">
                <a href="<?= base_url('faktur/add_faktur') ?>" class="btn btn-sm btn-info">
            ...
            <table class="table table-striped table-bordered table-hover" id="dt_faktur">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nomor Faktur</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_faktur').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('faktur/faktur_list') ?>",
                "type": "POST"
            },
    ...
    function delete_faktur(faktur_number) {
        Swal.fire({
            title: 'Are you sure ?',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url('faktur/delete_faktur/') ?>",
                    type: "POST",
                    data: {

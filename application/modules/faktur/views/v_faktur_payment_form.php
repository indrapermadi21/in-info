...
<section class="content">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Pembayaran Faktur</h3>
        ...
        <div class="card-body">
            <form id="form_inv_payment" action="<?= base_url('faktur/payment') ?>" method="POST" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-validation col-sm-3">
                        <input type="text" class="form-control" id="faktur_number" name="faktur_number" value="<?= !$result ? '' : $result['faktur_number'] ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-validation col-sm-3">
                        <input type="text" class="form-control" id="supplier" name="supplier" value="<?= !$result ? '' : $result['supplier'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="total_amount" class="col-sm-2 col-form-label">Total Faktur</label>
                    <div class="form-validation col-sm-2">

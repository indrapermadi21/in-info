<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Contract</h2>
            </div>
        </div>
        <!-- /.row -->
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw ti-file"></i> Data Contract
                        </h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_employee').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('contract/contract_list') ?>",
                "type": "POST"
            },
    ...
    function edit_contract(id) {
        $('#form_edit_contract')[0].reset(); // reset form on modals
    ...
    function save() {
        ...
        form_data = $('#form_edit_contract').serialize();
    ...
    function delete_contract(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url('contract/contract_delete/') ?>",
                    type: "POST",
                    data: {
                        id: id
                    },
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form_edit_contract" class="form-horizontal">

...
$html .= '<table cellpadding="1" >
    <tr>
        <td style="text-align: center;" colspan="4"><strong>INVOICE</strong></td>
    ...
    <tr>
        <td style="width: 75;">Kepada</td>
        <td style="width: 10;">:</td>
        <td style="width: 150">' . $results['customer_name'] . '</td>
        <td>&nbsp;</td>
        <td style="width: 100">No. Invoice</td>
        <td style="width: 10">:</td>
        <td style="width: 150">' . $results['invoice_number'] . '</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>

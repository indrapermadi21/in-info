    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="float-right">
                <a href="<?= base_url('invoice/add_invoice') ?>" class="btn btn-sm btn-info">
            ...
            <table class="table table-striped table-bordered table-hover" id="dt_invoice">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nomor Invoice</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_invoice').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('invoice/invoice_list') ?>",
                "type": "POST"
            },
